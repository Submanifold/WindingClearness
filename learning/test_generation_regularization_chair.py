...
def main(opt):
    ...
    with torch.no_grad():
        ...
        #model.load_state_dict(resumed_param, strict=False)
        model.load_state_dict(resumed_param)
...
def parse_args():
    ...
    parser.add_argument('--model', default='./new_joint_train_model_chair/model_12_joint.pth', help="path to model (to continue training)")

    '''eval'''

    parser.add_argument('--eval_path',
                        default='./results/regularized_output_plane')
