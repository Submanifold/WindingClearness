...
def parse_args():
    ...
    parser.add_argument('--category', default=['airplane', 'chair', 'car',
                                               'lamp', 'table', 'sofa',
                                               'cabinet', 'bench', 'telephone',
                                               'speaker', 'monitor', 'vessel', 'rifle'])
    ...
    parser.add_argument('--model', default='./ckpt/generation/all_13_599_2.pth', help="path to model (to continue training)")

    '''eval'''

    parser.add_argument('--eval_path',
                        default='./results/original_output_plane')
