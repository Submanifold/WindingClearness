...
def parse_args():
    ...
    parser.add_argument('--joint_train_save_path', default='new_joint_train_model_chair')
    ...
    #parser.add_argument('--lambda_joint', type=float, default=0.1, help='lambda_joint')
    ...
    parser.add_argument('--model', default='./ckpt/generation/chair_1799.pth', help="path to model (to continue training)")
